...
public class MainActivityWrite extends Activity {
    ...
    Button btnWrite, refuse, calculate_id, retrieve, save, finish;
...
//Toast.makeText(MainActivity.this,"getIntent "+getIntent().getStringExtra("type"),Toast.LENGTH_LONG).show();
        ...
        GpsTracker gps = new GpsTracker(MainActivityWrite.this);
        ...
        retrieve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (process.equals("farm")) {
                    ...
                    if (json.isEmpty()) {
                        Toast.makeText(MainActivityWrite.this, "يوجد خطأ", Toast.LENGTH_LONG).show();
                    } else {
            ...
            public void onClick(View v) {
                if (process.equals("farm")) {
                    if (type.equals("0") || classification.equals("0")) {
                        Toast.makeText(MainActivityWrite.this, "من فضلك اختار النوع او الصنف", Toast.LENGTH_LONG).show();
                    } else {
                        boolean ans = Constants.data.isEmpty();
                        if (ans == true) {
                            System.out.println("The ArrayList is empty");

                            Toast.makeText(MainActivityWrite.this, "لا يوجد صناديق متاحه", Toast.LENGTH_LONG).show();
                        } else {
                            ...
                            Toast.makeText(MainActivityWrite.this, "تم اضافه الصندوق الي قائمه الرفض", Toast.LENGTH_LONG).show();
                                    ...
                                    if (Constants.data_refused.contains(tvNFCContent.getText().toString())) {
                                        Toast.makeText(MainActivityWrite.this, "تم رفض الصندوق من قبل", Toast.LENGTH_LONG).show();
                                    } else {
                                Toast.makeText(MainActivityWrite.this, "تم اضافه الصندوق الي قائمه الرفض", Toast.LENGTH_LONG).show();
                    ...
                    if (type.equals("0") || classification.equals("0")) {
                        ...
                        if (ans == true) {
                            ...
                            if (Constants.data.contains(tvNFCContent.getText().toString())) {
                                ...
                                Toast.makeText(MainActivityWrite.this, "لايوجد صناديق متاحه", Toast.LENGTH_LONG).show();
                            }
                            System.out.println("The ArrayList is not empty");
                        }
                    }
...
//                Constants.data.add(Constants.general_master_batch_id + "-" + text + "-" + type + "-" + classification);
                ...
                Constants.data.add(Constants.general_master_batch_id + "-" + text + "-" + type + "-" + classification+" latitude "+latitude+" longitude "+longitude);
                      x = x + 1;
...
//                Constants.data.add(text +"-"+Constants.retailer_id+"-"+Constants.retailer_date);
                ...
                Constants.data.     add(text +"-"+Constants.retailer_id+"-"+Constants.retailer_date+" latitude "+latitude+" longitude "+longitude);
//
...
//        write_nfc(Constants.general_master_batch_id + "-" + tvNFCContent.getText().toString() + "-" + type + "-" + classification+"-"+ tvNFCContent.getText().toString());
    ...
    private void write(String text, Tag tag) throws IOException, FormatException {
        ...
        if(ndef.isWritable()){
           ...
           Toast.makeText(MainActivityWrite.this,"لا نستطيع قراءه",Toast.LENGTH_LONG).show();
        }
...
//            myTag1 = intent.getParcelableExtra(NfcAdapter.EXTRA_TAG);
        ...
        if (ndef.isWritable()) {
            ...
            Toast.makeText(MainActivityWrite.this, "لا نستطيع القراءه", Toast.LENGTH_LONG).show();
        }
    ...
    try {
        ...
        Toast.makeText(MainActivityWrite.this,tvNFCContent.getText().toString() +"-"+Constants.retailer_id+"-"+Constants.retailer_date+" latitude "+latitude+" longitude "+longitude,Toast.LENGTH_LONG).show();
...
//    }
    ...
    public void connect() {
        Log.d("sadas", "connect: ");
        hud1 = KProgressHUD.create(MainActivityWrite.this)
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(MainActivityWrite.this,
        ...
        ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(MainActivityWrite.this,
                android.R.layout.simple_spinner_item);
...
//                Toast.makeText(MainActivity.this,"Path is  "+path,Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(MainActivityWrite.this, "الصوره اتحفظت", Toast.LENGTH_SHORT).show();
        }
    }
...
//                    Toast.makeText(MainActivity.this,"f.getAbsolutePath() is  "+f.getAbsolutePath(),Toast.LENGTH_LONG).show();
            ...
            try {
                ...
                fo.close();
                Log.d("TAG", "File Saved::--->" + f.getAbsolutePath());
                Toast.makeText(MainActivityWrite.this, "f.getAbsolutePath() is  " + f.getAbsolutePath(), Toast.LENGTH_LONG).show();
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        ...
                        if (report.areAllPermissionsGranted()) {
                            Toast.makeText(getApplicationContext(), "كل الاذن قد منح", Toast.LENGTH_SHORT).show();
                        }
