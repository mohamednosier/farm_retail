...
import com.nfc.connect.nfc.OfflineGPS;
...
public class ProductLoad_FarmPieceActivity extends AppCompatActivity {
...
//    public static int x = 0;
    ...
    private DBFarmHelper mydb ;
    private DBFarmHelper1 mydb1 ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydb = new DBFarmHelper(ProductLoad_FarmPieceActivity.this);
        mydb1 = new DBFarmHelper1(ProductLoad_FarmPieceActivity.this);
        locationTrack = new LocationTrack(ProductLoad_FarmPieceActivity.this);
...
//                Toast.makeText(ProductLoad_FarmPieceActivity.this,"You shouldnot move it because of mistakes" +picker.getValue(),Toast.LENGTH_LONG).show();
...
//        Toast.makeText(ProductLoad_FarmPieceActivity.this,"type "+getIntent().getStringExtra("type"),Toast.LENGTH_LONG).show();
//        Toast.makeText(ProductLoad_FarmPieceActivity.this,"classifiction "+getIntent().getStringExtra("classification"),Toast.LENGTH_LONG).show();
...
//        int available_size=Constants.x-Constants.data_refused.size();
//        available.setText(""+available_size);
//        total.setText(""+Constants.x);
...
//        picker.setMax(Constants.x);
        farm_back=(ImageView) findViewById(R.id.farm_back2);
        farm_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog alertDialog = new AlertDialog.Builder(ProductLoad_FarmPieceActivity.this)
//set icon
...
//                                sharedPreferences.edit().clear().commit();
                                ...
                                Intent mainIntent = new Intent(ProductLoad_FarmPieceActivity.this, Product_FarmActivity.class);
                                ProductLoad_FarmPieceActivity.this.startActivity(mainIntent);
                                ProductLoad_FarmPieceActivity.this.finish();
                            }
                        })
//set negative button
                        ...
                        .setPositiveButton("نعم", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int ii) {
                                ...
                                if (mydb.numberOfRows()==0) {
                                    ...
                                    Toast.makeText(ProductLoad_FarmPieceActivity.this, "لايوجد صناديق متاحه", Toast.LENGTH_LONG).show();
                                } else {
                                        Boolean exist=false;
                                        ...
                                        if (exist==true) {
                                            ...
                                            if(mydb1.numberOfRows()==0){
                                                mydb = new DBFarmHelper(ProductLoad_FarmPieceActivity.this);
                                                List<Farmer_Data> contactsq = mydb.getAllFarms();
                                                mydb.deleteFarm1(contactsq.get(contactsq.size()-1));
                                                mydb1.addFarm(new Farmer_Data1(tvNFCContent.getText().toString()));


                                            Toast.makeText(ProductLoad_FarmPieceActivity.this, "تم اضافه الصندوق الي قائمه الرفض", Toast.LENGTH_LONG).show();
                                            refused.setText("" + mydb1.numberOfRows());
                                            ...
                                            picker.setValue(Float.parseFloat(String.valueOf(mydb.numberOfRows())));
                                                ...
                                                List<Farmer_Data1> contacts1 = mydb1.getAllFarms();
                                             for (Farmer_Data1 cn : contacts1) {
...
//                                            if (Constants.data_refused.contains(tvNFCContent.getText().toString())) {
                                                Toast.makeText(ProductLoad_FarmPieceActivity.this, "تم رفض الصندوق من قبل", Toast.LENGTH_LONG).show();
                                            } else {
//                                                Toast.makeText(ProductLoad_FarmPieceActivity.this, "تم اضافه الصندوق الي قائمه الرفض", Toast.LENGTH_LONG).show();
                                        ...
                                        Toast.makeText(ProductLoad_FarmPieceActivity.this, "لم يخزن الصندوف او تم رفضه من قبل ", Toast.LENGTH_LONG).show();
                                    }
                                    System.out.println("The ArrayList is not empty");
                                }
...
//                ArrayList array_list = mydb.getAllFarm();
                List<Farmer_Data> contacts = mydb.getAllFarms();
//                Toast.makeText(ProductLoad_FarmPieceActivity.this,"befor  "+mydb.numberOfRows(),Toast.LENGTH_LONG).show();
...
//                Toast.makeText(ProductLoad_FarmPieceActivity.this,"befor  "+mydb.numberOfRows(),Toast.LENGTH_LONG).show();
        ...
        finish_load.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(available.getText().toString().equals("0")){
                    Toast.makeText(ProductLoad_FarmPieceActivity.this,"من فضلك اختار بعض الصناديق ",Toast.LENGTH_LONG).show();
                }else {
                    ...
                    Intent mainIntent = new Intent(ProductLoad_FarmPieceActivity.this, ProductLoadResult_FarmActivity.class);
                    mainIntent.putExtra("available", "" + mydb.numberOfRows());
        ...
        scan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new IntentIntegrator(ProductLoad_FarmPieceActivity.this).setCaptureActivity(ScannerActivity.class).initiateScan();
            }
        });
refuse_last.setClickable(false);
refuse_last.setEnabled(false);
...
//                picker.setValue(1);
                ...
                if (Constants.data.contains(text)) {
                    Toast.makeText(ProductLoad_FarmPieceActivity.this,"هذا الصندوق مضاف ",Toast.LENGTH_LONG).show();
                    tvNFCContent.setText("" + text);
                } else {
...
////                    mydb = new DBFarmHelper(ProductLoad_FarmPieceActivity.this);
//                    if(mydb.insertFarm(type, classification,
//                            dateFormat.format(date), Constants.truck_id,Constants.farm_latitude+","+Constants.farm_longitude,text,
//                          "20")){
...
//                        picker.setMax(Constants.x);
                        ...
                        total.setText(""+Constants.x);
                        available.setText("" + (Constants.x - Constants.data_refused.size()));
                        picker.setValue(Float.parseFloat(String.valueOf((Constants.x - Constants.data_refused.size()))));
//                        picker.setMax(Constants.x);
                    }
                }
                System.out.println("The ArrayList is not empty");
    ...
    private void write(String text, Tag tag) throws IOException, FormatException {
        ...
        if(ndef.isWritable()){
            ...
            Toast.makeText(ProductLoad_FarmPieceActivity.this,"لانستطيع القراءه",Toast.LENGTH_LONG).show();
        }
...
//set negative button
    ...
    public void connect(String result) {
        ...
        locationTrack = new LocationTrack(ProductLoad_FarmPieceActivity.this);
        Log.d("locationTrack)", "connect: locationTrack.getLatitude()12"+locationTrack.getLatitude() + "," + locationTrack.getLongitude());
                ...
                if (parts.length == 4) {
                    if ( parts[1].contains("http://bit.ly/2xnoFZR")) {
                        ...
                        if (parts[2].equals("2011") || parts[2].equals("2012") || parts[2].equals("2013")) {
                            Toast.makeText(ProductLoad_FarmPieceActivity.this, "من فضلك اتاكد من الكود ", Toast.LENGTH_LONG).show();
                            ...
                            if (isNumeric(decrypted_text)) {
                                ...
                                if (mydb.numberOfRows() == 0) {
                                    ...
                                    if (exist == true) {
                                        ...
                                        Date date = new Date();
                                        System.out.println(dateFormat.format(date));
                                        Log.d("locationTrack.", "connect:locationTrack.getLatitude " + locationTrack.getLatitude());

                                        mydb.addFarm(new Farmer_Data(Constants.farmer_id, type, classification,
                                                dateFormat.format(date), Constants.truck_id, latitude + "," + longitude, text,
                                                "20"));
                                        available.setText("" + mydb.numberOfRows());
                                        tvNFCContent.setText("" + text);
